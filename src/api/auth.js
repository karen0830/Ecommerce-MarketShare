...
export const addShoppingCart = async (Data) => {
  try {
    const response = await ruta_protegida().post("/addShoppingCart", Data)
    return response
  } catch (error) {
    console.log(error);
  }
...
export const getShoppingCart = async () => {
  try {
    const response = await ruta_protegida().get("/getAllShoppingCarts");
    return response;
  } catch (error) {
    console.log(error);
  }
...
export const decrementProduct = async (Data) => {
  try {
    const response = await ruta_protegida().put("/decrementQuantityCart", Data);
    return response;
  } catch (error) {
    console.log(error);
  }
...
export const deleteCart = async (Data) => {
  try {
    const response = await ruta_protegida().post("/deleteShoppingCart", Data);
    return response;
  } catch (error) {
    console.log(error);
  }
...
export const getTokenSocialNetwork= async (Data) => {
  try {
    const response = await ruta_protegida().post("/getTokenSocialNetwork", Data);
    return response;
  } catch (error) {
    console.log(error);
  }
